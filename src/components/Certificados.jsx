...
const [modal4, setModal4] = useState(false)
  ...
  return (
    <div id='certificados' className='mx-6'>
        ...
        <div className='grid grid-cols-4 grid-certificados mt-20 mx-12'>
            <div className='flex flex-col justify-center items-center'>
                ...
                <div className='h-36 mt-8 w-40 hover:w-44 duration-1000'><a target="_blank" href="https://www.udemy.com/share/102qkK3@F0rMEjWKy7DfLd94iGJvX3xnK7vBsMFfnit-LFtNzmJaTAqFpIFX86IBHWgpR6m-ag==/">
            ...
            <div className='flex flex-col justify-center items-center'>
                ...
                <div className='h-36 mt-8  w-40 hover:w-44 duration-1000'><a target="_blank" href="https://www.udemy.com/share/103dum3@1ysJJwg-WrC3cZGdR8JIoHHPQHUTiOdev6WF8DtUkr1cnxHMdDyW2aToA6D6qn0ohw==/"> 
                <img className='rounded-xl object-center' src={logoUdemy} alt="" /></a>
                </div>
                <div className='text-center text-white bg-zinc-900 rounded-xl w-32 hover:bg-zinc-600 duration-700 p-1 boton-certificado'><button onClick={() => setModal3(true)}>Certificado</button> </div>
            </div>
            <div className='flex flex-col justify-center items-center'>
                <h3 className='text-center'>Javascript moderno <br /> <span className='autor-curso'>Juan Pablo De la torre</span></h3>
                <div className='h-36 mt-8 w-40 hover:w-44 duration-1000'><a target="_blank" href="https://www.udemy.com/share/1020Na3@oiAdVO2oWaN8b6fEYpeCxsyGaB8UD6Dey7st0ZjANJhG6YnyizbFd4S-wjFqSD8XvQ==/"> 
                <img className='rounded-xl object-center' src={logoUdemy} alt="" /> </a></div>
                <div className='text-center text-white bg-zinc-900 rounded-xl w-32 hover:bg-zinc-600 duration-700 p-1 boton-certificado'><button onClick={() => setModal4(true)}>Certificado</button> </div>
            </div>
        </div>
