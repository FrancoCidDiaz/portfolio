      ...
      <div className='grid grid-cols-2 grid-rows-2 place-content-center justify-center items-center mx-8 grid-proyectos'>
        ...
        <div>
          <div className='w-100 mt-10 div-proyectos'>
            ...
            <a target="_blank" href="https://quiz-f1.vercel.app/"><img className='w-100 rounded-xl h-52 shadow-lg hover:shadow-black duration-1000 mt-6 m-auto' src={quiz} alt="" /></a>
          </div>
          <div className='w-10  flex justify-center mx-auto gap-4 pt-8'>
            <img src={logoReact} alt="" />
            <img src={logoBootstrap} alt="" />
          ...
          <div>
            <a target="_blank" href="https://github.com/FrancoCidDiaz/quiz-f1"><img className='w-12 mx-auto rounded-full mt-4 shadow-lg hover:shadow-black duration-1000' src={logoGithub} alt="" /></a>
          </div>
        </div>
        <div>
          <div className='w-100 mt-10 div-proyectos'>
            ...
            <a target="_blank" href="https://tip-calculator-seven-rose.vercel.app"><img className='w-100 rounded-xl h-52 shadow-lg hover:shadow-black duration-1000 mt-6 m-auto' src={tipCalculator} alt="" /></a>
          </div>
          <div className='w-10  flex justify-center mx-auto gap-4 pt-8'>
            <img src={logoReact} alt="" />
            <img src={logoTailwind} alt="" />
          ...
          <div>
            <a target="_blank" href="https://github.com/FrancoCidDiaz/tip-calculator"><img className='w-12 mx-auto rounded-full mt-4 shadow-lg hover:shadow-black duration-1000' src={logoGithub} alt="" /></a>
          </div>
        </div>
        <div>
          <div className='w-100 mt-10 div-proyectos'>
